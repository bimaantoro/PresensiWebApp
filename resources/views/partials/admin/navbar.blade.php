    ...
    <div class="container-xl">
      ...
      <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
        <a href="{{ route('dashboard-admin') }}">
          <img src="{{ asset('assets/img/icon/192x192.png') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
        </a>
      </h1>
        ...
        <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown {{ request()->is(['admin/employees', 'admin/pengajuan-izin-karyawan']) ? 'active' : '' }}">
              <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="{{ request()->is(['admin/employees', 'admin/pengajuan-izin-karyawan']) ? 'active' : '' }}" >
              ...
              <div class="dropdown-menu {{ request()->is(['admin/employees', 'admin/pengajuan-izin-karyawan']) ? 'active' : '' }}">
                <div class="dropdown-menu-columns">
                  <div class="dropdown-menu-column">
                    <a class="dropdown-item {{ request()->is('admin/employees') ? 'active' : '' }}" href="/admin/employees">
                      Data Karyawan
                    </a>
                    <a class="dropdown-item {{ request()->is('admin/pengajuan-izin') ? 'active' : '' }}" href="/admin/pengajuan-izin">
                      Data Izin / Sakit
                    </a>
                  </div>
                </div>
