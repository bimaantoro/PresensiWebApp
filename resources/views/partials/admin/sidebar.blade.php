    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item dropdown {{ request()->is(['admin/presence-student/report', 'admin/presence-student/recap']) ? 'active' : '' }}">
            <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['admin/presence-student/report', 'admin/presence-student/recap']) ? 'true' : '' }}">
              <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
            ...
            <div class="dropdown-menu {{ request()->is(['admin/presence-student/report', 'admin/presence-student/recap']) ? 'show' : '' }}">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a class="dropdown-item {{ request()->is('admin/presence-student/report') ? 'active' : '' }}" href="{{ route('report-presence-admin') }}">
                    Presensi
                  </a>
                  <a class="dropdown-item {{ request()->is('admin/presence-student/recap') ? 'active' : '' }}" href="{{ route('recap-presence-admin') }}">
                    Rekap Presensi
                  </a>
                </div>
              </div>
