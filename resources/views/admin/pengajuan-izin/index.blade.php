...
@section('title', 'Data Izin / Sakit Karyawan')    
@section('content')
                ...
                <div class="row">
                    <div class="col-3 mb-3">
                        <div class="input-icon">
                            ...
                            <input type="text" class="form-control" id="id-employee" name="id_employee" placeholder="ID Karyawan" value="{{ request()->id_employee }}">
                        </div>
                    </div>
                    <div class="col-3 mb-3">
                        <div class="input-icon">
                            ...
                            <input type="text" class="form-control" id="fullname" name="fullname" placeholder="Nama Lengkap" value="{{ request()->fullname }}" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-3">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/admin/pengajuan-izin/approve" id="form-add-employee" method="POST">
                @method('PUT')
                @csrf
